...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`AutoWerk`}</title>

        <meta
          name="description"
          content="Welcome to AutoWerk - your reliable Car Service Application. Ensuring smooth rides and peace of mind, one service at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXJ8ZW58MHx8fHwxNjk2NDE3NzI1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@introspectivedsgn?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Erik Mclean`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to AutoWerk - your reliable Car Service Application. Ensuring smooth rides and peace of mind, one service at a time.`}
            </Text>
            <Box
