...
export function ServiceListPage(props: ServiceListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getServices({
        relations: ['company', 'appointment.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'description.contains', 'service_type.contains', 'product_type.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'product_type', header: 'Product Type', accessorKey: 'product_type' },
